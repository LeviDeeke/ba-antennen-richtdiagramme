%% 3D-Richtdiagramm der S-Band-Antenne
% Dieses Skript liest 3D-Messdaten einer S-Band-Antenne aus einer Excel-Datei ein,
...
%% Eingabedatei
filename = "S Band 3D.xlsx";           % Name der Excel-Datei mit den Messdaten

%% Darstellungsparameter
dynRange3D = 55;                       % Dynamikbereich fuer die 3D-Farbskala in dB
dynRangePolar = 55;                    % Dynamikbereich fuer den 2D-Polarschnitt in dB
...
title("3D-Richtdiagramm der S-Band-Antenne"); % Titel der 3D-Figur
...
title("Richtdiagramm der S-Band-Antenne (Elevation = 0°)");
% Titel der 2D-Figur setzen

rTicksPolar = (-dynRangePolar:10:0) + dynRangePolar;  % Radiale Tick-Positionen berechnen
dbTicksPolar = -dynRangePolar:10:0;                   % Zugehoerige dB-Beschriftungen definieren
...
%% Optionaler Export
% exportgraphics(gcf, 'SBand_0deg_cut.png', 'Resolution', 300);
