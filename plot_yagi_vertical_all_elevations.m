%% Alle 2D-Polarschnitte der vertikalen Yagi-Messung von 0° bis 90°
% Dieses Skript liest die 3D-Messmatrix der vertikalen Yagi-Messung aus
...
%% Eingabedatei
filename = "Yagi 3D Vertikal.xlsx";
% Name der Excel-Datei mit den Messdaten der vertikalen Yagi-Messung
...
%% Konsolenausgabe
fprintf("Alle %d Polarschnitte für Yagi 3D Vertikal erstellt.\n", nEl);
...
%% Optionaler Export
% exportgraphics(gcf, 'Yagi_Vertical_All_Elevations.png', 'Resolution', 300);
