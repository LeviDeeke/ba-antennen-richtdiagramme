%% Alle 2D-Polarschnitte der horizontalen Yagi-Messung von 0° bis 90°
% Dieses Skript liest die 3D-Messmatrix der horizontalen Yagi-Messung aus
% einer Excel-Datei ein, normiert alle Werte auf das globale Maximum,
% richtet alle Elevationsschnitte mit derselben festen Rotation aus und
% stellt sie als Kachelansicht von 2D-Polardiagrammen dar.

clear; clc; close all;                  % Workspace, Konsole und geoeffnete Figuren zuruecksetzen

%% Eingabedatei
filename = "Yagi 3D Pattern Horizontal 2.xlsx";
% Name der Excel-Datei mit den Messdaten der horizontalen Yagi-Messung

%% Darstellungsparameter
dynRangePolar = 45;                     % Sichtbarer Dynamikbereich der Polarplots in dB
...
title(t, "2D-Polarschnitte der Yagi-Antenne für Elevation = 0° bis 90°", ...
...
for k = 1:nEl                           % Ueber alle Elevationsspalten der Messmatrix laufen
    ...
    rTicksPolar = (-dynRangePolar:15:0) + dynRangePolar;
    % Radiale Tick-Positionen im verschobenen Koordinatensystem berechnen

    dbTicksPolar = -dynRangePolar:15:0;
...
%% Konsolenausgabe
fprintf("Alle %d Polarschnitte für Yagi 3D Pattern Horizontal 2 erstellt.\n", nEl);
...
%% Optionaler Export
% exportgraphics(gcf, 'Yagi_Horizontal_All_Elevations.png', 'Resolution', 300);
